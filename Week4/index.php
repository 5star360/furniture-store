...
<section class="hero">
  <div class="hero-inner">
    ...
    <p>Discover our hand-curated collection of premium sofas, chairs, beds and more.</p>
...
<main class="main-content" id="catalog">
  ...
  <div class="filter-bar">
    <div class="search-wrap">
      ...
      <input type="text" id="productSearch" class="search-input" placeholder="Search furniture…">
    </div>
